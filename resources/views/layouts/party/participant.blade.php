        ...
        <div class="mt-2 flex flex-row-reverse">
            ...
            @if ($loggedInWithSpotify)
                <label class="relative inline-flex items-center mr-5 cursor-pointer">
                    <input type="checkbox" value="" name="searchSpotify" id="searchSpotify" class="sr-only peer">
                    <div
            ...
            {{-- YouTube --}}
            <label class="relative inline-flex items-center mr-5 cursor-pointer">
                <input type="checkbox" value="" name="searchYouTube" id="searchYouTube" class="sr-only peer">
                <div
